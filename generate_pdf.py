...
def generate_pdf(company, filename, full_name, mobile, email, date, notes):
    ...
    c.drawImage('order.png',20, 320, width=890, preserveAspectRatio=True, anchor='c')
    ...
    # c.drawImage('insert_logo_here.png',40, 740, width=162.5, preserveAspectRatio=True, mask='auto', anchor='c')
